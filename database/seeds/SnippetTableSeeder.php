...
$id = DB::table('snippet_table')->insertGetId(array('account_id'=>'1','title'=>'XMLHttpRequestによるAJAXリクエスト','created_at'=>'2014-10-04 11:05:56','updated_at'=>'2014-10-04 11:05:56','content'=>'XMLHttpRequestに関するサンプルコード\n```\nvar xhr = new XMLHttpRequest();\nxhr.open(\'POST\', \'/json/images/upload\');\nxhr.onload = function () {\n	var res = xhr.responseText\n  	if (xhr.status === 200) {\n  		console.log(res);\n  	} else {\n  		// failed to uploaded\n    	console.log(\'Something went terribly wrong...\');\n  	}\n};\n\nxhr.send(formData);\n```'));
DB::table('snippet_tag')->insert(array('tag_id'=>7,'snippet_id'=>$id,'created_at'=>'2014-10-04 11:05:56','updated_at'=>'2014-10-04 11:05:56'));

$id = DB::table('snippet_table')->insertGetId(array('account_id'=>'1','title'=>'スムーズスクロールアニメーション','created_at'=>'2014-10-04 10:44:24','updated_at'=>'2014-10-04 10:44:24','content'=>'```\n$(\'html, body\').animate({scrollTop:0}, 400);\n```'));
